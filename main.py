...
class MyServer(BaseHTTPRequestHandler):
    ...
    def __get_index(self):
        with open("index.html", encoding="utf8") as template:
            text = template.read()
        return text
        return """  
        <html><head><title>Blog</title></head><body>        <h1>Lorem blog</h1>        <ul>        <li><a href='/?page=news1'>New one</a></li>        <li><a href='/?page=news2'>New two</a></li>        <li><a href='/?page=news3'>New three</a></li>        </ul>        </body>        </html>        """
    ...
    def __get_blog_article(self, page_address):
        return f"""  
        <html><head><title>Blog</title></head><body>        <a href="/">Back</a><br>        <p>{self.__get_article_content(page_address)}</p>  
        </body>        </html>        """
